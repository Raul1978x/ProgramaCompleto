...
-- Tiempo de generación: 20-11-2022 a las 12:29:05
...
--
-- Creación: 19-11-2022 a las 11:33:56
--
...
--
-- Creación: 19-11-2022 a las 11:47:44
--
...
CREATE TABLE `equipos` (
  ...
  `anio_ingreso` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Esta tabla es para el registrar equipos';
...
--
-- Creación: 19-11-2022 a las 11:28:52
--
...
(1, 'Raul Gonzalez', 'raul@ejemplo.com', '4302016', 'RaulGonz', '123456', 'Administrador', 'Activo', 'Raul'),
(2, 'Raul Gomez', 'raul@ejemplo.com', '4302016', 'Raul', '123456', 'Administrador', 'Activo', 'Raul'),
(3, 'Matias Gomez', 'matias@ejemplo.com', '261-4302016', 'Matias', '123456', 'tecnico', 'Activo', 'Raul'),
(4, 'Agustin Gómez', 'agustin@ejemplo.com', '4302016', 'Agustin', '123456', 'Capturista', 'Activo', 'Raul'),
(5, 'Itai Bejar', 'itai@ejemplo.com', '4455678', 'Itai', '123456', 'Tecnico', 'Activo', 'Raul');
...
--
CREATE DATABASE IF NOT EXISTS `bd_prueba` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `bd_prueba`;
...
--
-- Creación: 14-11-2022 a las 15:13:03
--
...
--
-- Creación: 14-11-2022 a las 14:56:20
--
...
('root', '[{\"db\":\"bd_ds\",\"table\":\"usuarios\"},{\"db\":\"bd_ds\",\"table\":\"equipos\"},{\"db\":\"bd_ds\",\"table\":\"clientes\"},{\"db\":\"bd_prueba\",\"table\":\"alumnos\"}]');
...
--
-- Creación: 14-11-2022 a las 14:56:20
-- Última actualización: 20-11-2022 a las 11:27:57
--
...
('root', '2022-11-20 11:27:57', '{\"Console\\/Mode\":\"show\",\"lang\":\"es\",\"NavigationWidth\":0,\"Console\\/Height\":91.98639999999999}');
